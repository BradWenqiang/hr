		...
		<!--  这下面放一个隐藏的input框-->
			...
			<div class="modal-content" style="background: #F5F5F5;">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">新增薪资信息</h4>
				</div>
				<!-- <form class="form-inline horizontal " role="form"> -->
				<form class="form-horizontal" role="form" id="wageForm" >
					<div class="modal-body" style="height: 60%;">
						<div class="col-lg-10 col-md-9 col-sm-9 ">
							...
							<div class="form-group " >
								...
								<div class=" col-lg-4 " style=" padding-top: 25px;">
								 <input
									type="text" class="form-control  col-lg-4 " name="departments"
									id="departments" placeholder="请输入部门名称">
								</div>
								<label for="name" class=" col-lg-2 control-label" style=" padding-top: 30px;">基本薪资</label>
								<div class=" col-lg-4 " style=" padding-top: 25px;">
								 <input
									type="text" class="form-control  col-lg-4 " name="bsalary"
									id="bsalary" placeholder="请输入基本薪资">
								</div>
								<label for="name" class=" col-lg-2 control-label" style=" padding-top: 30px;">保险费</label>
								<div class=" col-lg-4 " style=" padding-top: 25px;">
									<input type="text" class=" form-control  " name="premium"
										id="premium" placeholder="请输入保险费">
								</div>	
							</div>
			...
			fields : {
				...
				function(e) {//点击提交之后
					...
					// Use Ajax to submit form data 提交至form标签中的action，result自定义
				 	...
				 	var wage = getFormData($("#wageForm"));  
					  $.ajax({
				        type : $("#submitType").val(),  //请求方式
				        url : "${pageContext.request.contextPath}/wage",  //请求路径
				        data: wage, 
				        async: true,
				        dataType:"json",   
